	...
	var open = function (data) {
		...
		if (localStorage) {
			if (localStorage.getItem('WG.nightmode') === 'on') {
				document.body.setAttribute('lf', 'substance');
			}
		}
...
WG.ui = {
	...
	createUIComponents: function () {
		...
		// Log
		if (console) {
			console.log('WG.uiComponents created');
		}
	...
	bindEvents: function () {
		...
		// Log
		if (console) {
			console.log('WG.ui events bound');
		}
		...
		.bind('hashchange', function (e) {
			...
			if (!(document.location.hash in WG.ui.viewHistory)) {
				if (console) {
					console.log('Warning: view hash not found (' + document.location.hash + ')');
				}
				return;
			}
			...
			// Log
			if (console) {
				console.log('Set view: ' + info.name);
			}
